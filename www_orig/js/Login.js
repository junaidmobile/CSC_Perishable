...
var GHAserviceURL =
  "https://adaniuat.kalelogistics.com/GHALKO/Services/HHTExpServices.asmx/";
...
var GHAImportFlightserviceURL = 'https://adaniuat.kalelogistics.com/GHALKO/Services/HHTImpServices.asmx/';
...
//var GHAImportFlightserviceURL = "https://adaniuat.kalelogistics.com/GHALKO/Services/HHTImpServices.asmx/";
//var GHAExportFlightserviceURL = 'http://10.0.1.7/GHAHHT/Services/HHTImpServices.asmx/';
// var GHAImportFlightserviceURL = 'http://10.22.2.71:8080/CELEBIHHT/Services/HHTImpServices.asmx/';

var GHAExportFlightserviceURL = 'https://adaniuat.kalelogistics.com/GHALKO/Services/HHTExpServices.asmx/';
...
//var CMSserviceURL = 'http://113.193.225.59:8080/CELEBIWebservice/CMS_WS_PDA.asmx/';
//var CMSserviceURL = 'http://113.193.225.59:8080/CELEBIHHTCMS_New/CMS_WS_PDA.asmx/';
var CMSserviceURL = 'https://adaniuat.kalelogistics.com/AdaniLKOWS_PDA/CMS_WS_PDA.asmx/';
//var CMSserviceURL =  "https://adaniuat.kalelogistics.com/AdaniCMSWebserviceLKO/CMS_WS_PDA.asmx/";
                ...
                if (str != null && str != "" && str != "<NewDataSet />") {
                    ...
                    $(xmlDoc)
                      ...
                      .each(function (index) {
                          ...
                          window.localStorage.setItem(
                            "companyCode",
                            $(this).find("CompanyCode").text()
                          );
                          window.localStorage.setItem(
                            "SHED_AIRPORT_CITY",
                            $(this).find("SHED_AIRPORT_CITY").text()
                          );
                          window.localStorage.setItem(
                            "SHED_CODE",
                            $(this).find("SHED_CODE").text()
                          );

                          window.localStorage.setItem("GHAserviceURL", GHAserviceURL);
                          window.localStorage.setItem(
                            "GHAImportFlightserviceURL",
                            GHAImportFlightserviceURL
                          );
                          window.localStorage.setItem(
                            "GHAExportFlightserviceURL",
                            GHAExportFlightserviceURL
                          );
    ...
    if (connectionStatus == "offline") {
        ...
        setInterval(function () {
            ...
            if (connectionStatus == "online") {
                ...
                $.tips(
                  "You are offline. Please contact IT helpdesk at +918860130401, 01125601027 </br>Email: ithelpdesk@celebiaviation.in"
                );
            }
        }, 3000);
    }
            ...
            success: function (response) {
                ...
                if (str != null && str != "" && str != "<NewDataSet />") {
                    ...
                    $(xmlDoc)
                      ...
                      .each(function (index) {
                          if (
                            $(this).find("Module").text() == "EXPORTS" &&
                            $(this).find("PermissionCode").text() == "HVTX"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                                  window.localStorage.setItem("RoleExpDashboard", "1");
                              } else window.localStorage.setItem("RoleExpDashboard", "0");
                          }

                          if (
                            $(this).find("Module").text() == "EXPORTS" &&
                            $(this).find("PermissionCode").text() == "HVTM"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                          ...
                          if (
                            $(this).find("Module").text() == "EXPORTS" &&
                            $(this).find("PermissionCode").text() == "HTDM"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                                  window.localStorage.setItem("RoleExpTDG", "1");
                              } else window.localStorage.setItem("RoleExpTDG", "0");
                          }

                          if (
                            $(this).find("Module").text() == "EXPORTS" &&
                            $(this).find("PermissionCode").text() == "HEBI"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                                  window.localStorage.setItem("RoleExpBinning", "1");
                              } else window.localStorage.setItem("RoleExpBinning", "0");
                          }

                          if (
                            $(this).find("Module").text() == "EXPORTS" &&
                            $(this).find("PermissionCode").text() == "HEIM"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                                  window.localStorage.setItem("RoleExpIntlMvmt", "1");
                              } else window.localStorage.setItem("RoleExpIntlMvmt", "0");
                          }

                          if (
                            $(this).find("Module").text() == "EXPORTS" &&
                            $(this).find("PermissionCode").text() == "HUNI"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                                  window.localStorage.setItem("RoleExpUnitization", "1");
                              } else window.localStorage.setItem("RoleExpUnitization", "0");
                          }

                          if (
                            $(this).find("Module").text() == "EXPORTS" &&
                            $(this).find("PermissionCode").text() == "HARM"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                          ...
                          if (
                            $(this).find("Module").text() == "EXPORTS" &&
                            $(this).find("PermissionCode").text() == "HEQM"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                                  window.localStorage.setItem("RoleExpExportsQuery", "1");
                              } else window.localStorage.setItem("RoleExpExportsQuery", "0");
                          }

                          if (
                            $(this).find("Module").text() == "EXPORTS" &&
                            $(this).find("PermissionCode").text() == "HVCT"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                                  window.localStorage.setItem("RoleExpVCTCheck", "1");
                              } else window.localStorage.setItem("RoleExpVCTCheck", "0");
                          }

                          if (
                            $(this).find("Module").text() == "IMPORTS" &&
                            $(this).find("PermissionCode").text() == "HFLTX"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                                  window.localStorage.setItem("RoleImpDashboard", "1");
                              } else window.localStorage.setItem("RoleImpDashboard", "0");
                          }

                          if (
                            $(this).find("Module").text() == "IMPORTS" &&
                            $(this).find("PermissionCode").text() == "HFLTC"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                                  window.localStorage.setItem("RoleIMPFlightCheck", "1");
                              } else window.localStorage.setItem("RoleIMPFlightCheck", "0");
                          }

                          if (
                            $(this).find("Module").text() == "IMPORTS" &&
                            $(this).find("PermissionCode").text() == "HSEG"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                                  window.localStorage.setItem("RoleIMPSegregation", "1");
                              } else window.localStorage.setItem("RoleIMPSegregation", "0");
                          }

                          if (
                            $(this).find("Module").text() == "IMPORTS" &&
                            $(this).find("PermissionCode").text() == "HIBIN"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                                  window.localStorage.setItem("RoleIMPBinning", "1");
                              } else window.localStorage.setItem("RoleIMPBinning", "0");
                          }

                          if (
                            $(this).find("Module").text() == "IMPORTS" &&
                            $(this).find("PermissionCode").text() == "HIIM"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                                  window.localStorage.setItem("RoleIMPIntlMvmt", "1");
                              } else window.localStorage.setItem("RoleIMPIntlMvmt", "0");
                          }

                          if (
                            $(this).find("Module").text() == "IMPORTS" &&
                            $(this).find("PermissionCode").text() == "HFBM"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                                  window.localStorage.setItem("RoleIMPFwdBkd", "1");
                              } else window.localStorage.setItem("RoleIMPFwdBkd", "0");
                          }

                          if (
                            $(this).find("Module").text() == "IMPORTS" &&
                            $(this).find("PermissionCode").text() == "FDM"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                                  window.localStorage.setItem("RoleIMPFinalDelivery", "1");
                              } else window.localStorage.setItem("RoleIMPFinalDelivery", "0");
                          }

                          if (
                            $(this).find("Module").text() == "IMPORTS" &&
                            $(this).find("PermissionCode").text() == "IQM"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                                  window.localStorage.setItem("RoleIMPImportQuery", "1");
                              } else window.localStorage.setItem("RoleIMPImportQuery", "0");
                          }

                          if (
                            $(this).find("Module").text() == "IMPORTS" &&
                            $(this).find("PermissionCode").text() == "IDUM"
                          ) {
                              if ($(this).find("IsPermit").text() == "true") {
                                  window.localStorage.setItem("RoleIMPDocUpload", "1");
                              } else window.localStorage.setItem("RoleIMPDocUpload", "0");
                          }
                      });
                } else {
                    HideLoader();
